package com.emretoprak.eticaret.services.customer.cart;

import com.emretoprak.eticaret.dto.AddProductInCartDto;
import com.emretoprak.eticaret.dto.CartItemsDto;
...
import com.emretoprak.eticaret.repository.*;
    ...
    public OrderDto decreaseProductQuantity(AddProductInCartDto addProductInCartDto) {
        ...
        if (optionalProduct.isPresent() && optionalCartItem.isPresent()) {
            ...
            if(cartItem.getQuantity() == 1){
                // Ürün miktarı 1 ise ürünü sepetten çıkar ve tutarı güncelle
                activeOrder.setAmount(activeOrder.getAmount() - product.getPrice());
                activeOrder.setTotalAmount(activeOrder.getTotalAmount() - product.getPrice());
                cartItemsRepository.delete(cartItem);
            } else {
                // Ürün miktarını azalt ve tutarı güncelle
                cartItem.setQuantity(cartItem.getQuantity() - 1);
                activeOrder.setAmount(activeOrder.getAmount() - product.getPrice());
                activeOrder.setTotalAmount(activeOrder.getTotalAmount() - product.getPrice());
